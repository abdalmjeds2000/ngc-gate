...
function IssuingVISA() {
  ...
  const [isAdmin] = useIsAdmin("Issuing VISA Admins");
  ...
  return (
    <>
      ...
      
      {
        !loading
        ? <FormPage
            pageTitle={!id ? 'New VISA Application' : requestData.ReferenceCode}
            Header={
