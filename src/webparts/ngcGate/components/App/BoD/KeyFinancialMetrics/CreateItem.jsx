...
import NewSelectItem from '../../PerformanceManagement/CorporateObjectiveKPIs/components/NewSelectItem';
...
const CreateItem = ({ dataSource, onSuccess }) => {
  ...
  return (
    <>
      <Button type='primary' size='small' onClick={() => setOpenDrawer(true)} loading={loading} icon={<PlusOutlined />}>
        New
      </Button>
