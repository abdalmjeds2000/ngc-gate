        ...
        <Row gutter={12}>
          ...
          <Col span={24}>
            <Form.Item label='Points:' required style={{marginBottom: 0, textAlign: 'center'}}>
              ...
              { meetData?.points?.length < 7 ? <Button size='small' shape='circle' onClick={() => onChangeItem(meetData.id, {points: [...meetData?.points, { id: uniqueId(), value: '' }]})} icon={<PlusOutlined />} /> : null }
            </Form.Item>
          </Col>
        </Row>
      </Form.Item>
