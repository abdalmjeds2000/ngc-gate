export const groupedData = (data) => {
  let groupLvl_1 = data.reduce((r, a) => {
    ...
    r[a.FType?.trim()] = [...(r[a.FType?.trim()] || []), a];
    return r;
  }, {});
  ...
  Object.values(groupLvl_1).map((row, i) => {
    let groupLvl_2 = Object.values(row).reduce((r, a) => {
      // r[a.SubClassification] = [...(r[a.SubClassification] || []), a];
      r[a.SubClassification?.trim()] = [...(r[a.SubClassification?.trim()] || []), a];
      return r;
    }, {});
    Object.values(groupLvl_2).map((obj, ii) => {
      let groupLvl_3 = Object.values(obj).reduce((r, a) => {
        r[a.Description?.trim()] = [...(r[a.Description?.trim()] || []), a];
        return r;
      }, {});
      dataTable.push({
        key: `${i}_${ii}`,
