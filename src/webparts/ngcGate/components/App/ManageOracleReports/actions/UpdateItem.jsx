...
const UpdateItem = ({ item, folders, onFinish }) => {
  ...
  const handleUpdate = async (form_values) => {
    ...
    const response = await axios.post("https://salicapi.com/api/reports/Update", payload);
  ...
  const getPermission = async () => {
    const permissionsList = await axios.get(`https://salicapi.com/api/reports/GetPermissionsByLinkId?LinkId=${item.id}`);
